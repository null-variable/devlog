...
import com.nullvariable.devlog.utils.GetRandom;
import com.nullvariable.devlog.utils.Hash;
import com.nullvariable.devlog.utils.JpaConnect;
...
public class AuthServiceImpl implements AuthService {
    ...
    public ResponseEntity<Object> Me(
        ...
        if (data.isPresent()) {
            ...
            BasicResponse response = BasicResponse.builder()
                    .success(false)
                    .message(Optional.of("비 정상적인 토큰 입니다."))
                    .data(Optional.empty())
                    .build();
