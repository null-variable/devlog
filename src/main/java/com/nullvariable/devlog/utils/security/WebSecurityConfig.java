package com.nullvariable.devlog.utils.security;

import com.nullvariable.devlog.enums.Roles;
import com.nullvariable.devlog.utils.jsonwebtoken.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/community/user/**").hasAnyRole("USER", "ADMIN")
